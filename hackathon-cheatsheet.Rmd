...
In this hackathon, we will work together to create a _data analysis walkthrough onesheet_, a minimalistic resource designed specifically for R beginners, providing the bare bones of what is required when approaching data analysis in R. By keeping the walkthrough to a onesheet that can be printed, the user has the option of saving valuable screen space. 
...
In addition to developing the _data analysis walkthrough onesheet_, our working group has metascience goals in mind. We would like to clarify the definitions of _walkthrough_ and _meritget_, and delineate these concepts in a manuscript about the data analysis walkthrough onesheet. 
