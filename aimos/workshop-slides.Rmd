...
```
# Keep the ones you want, column 1 and 2
betterdata <- yourdata %>%
  select(col1, col2) 
...
```
# Keep more than one column, columns 1 thru 5
betterdata <- yourdata %>%
  select(col1:col5) 
...
```
# Drop columns you don't want using -name, drop column 6
betterdata <- yourdata %>%
  select(-col6) 
...
# Your turn... have a go at solving problems 1-5
